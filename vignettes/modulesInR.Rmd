...
considerably complicate things. I lack the conceptual competence to explain 
these things with the depth they deserve, so I only present a couple of examples
you can consider for stronger forms of coupling between modules.
...
And of course we can do this with `reInit = FALSE` should this be desirable:
...
In this case both modules are essentially the same.
